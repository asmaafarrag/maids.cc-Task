...
@Component({
  selector: 'app-invs-in',
  templateUrl: './invs-in.component.html',
  styleUrls: ['./invs-in.component.css']
})
export class InvsInComponent implements OnInit {
  ...
  showSuccess() {
    this.toastr.success('تم حفظ سند القبض', 'سند القبض');
  }
