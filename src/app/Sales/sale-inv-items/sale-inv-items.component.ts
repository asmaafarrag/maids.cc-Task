...
@Component({
  selector: 'app-sale-inv-items',
  templateUrl: './sale-inv-items.component.html',
  styleUrls: ['./sale-inv-items.component.css']
})
export class SaleInvItemsComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<SaleInvItemsComponent>, private servStockService: ServStockService
