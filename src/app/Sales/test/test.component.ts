...
export class TestComponent implements OnInit {
  ...
  constructor(private servStockService: ServStockService, public servSellingRet: SellingRetService , private treasuryServ: TreasuryService
  ...
  AddOrEditSalInvItems(orderItemIndex, SellingRetId) {
    if (this.validateForPopUp()) {
      ...
      this.dialog.open(TestItemsComponent, dialogConfig).afterClosed().subscribe(res => { this.calcGrandTotal(); this.calcItemsQty(); });
    }
  }
