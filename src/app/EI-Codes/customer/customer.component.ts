...
export class CustomerComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data , public CustService: CustomerService, private servStockService: ServStockService, private servAccIncListQService: AccIncListQService
    ,public  GovernateServ:GovernateService ,public regionServ:RegionCitiesService,
    public dialogRef: MatDialogRef<CustomerComponent>, public countryServ:CountryService , public BranchServ:BranchService , private dialog: MatDialog, private toastr: ToastrService, public datepipe: DatePipe, public currentRoute: ActivatedRoute, private router: Router) {
  ...
  validateForm() {
    ...
    // else if (this.CustService.formData.CountryID == null || this.CustService.formData.CountryID == 0)
    //   this.isValid = false;
