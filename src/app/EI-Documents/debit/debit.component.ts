...
export class DebitComponent implements OnInit {
  ...
  // constructor(private servStockService: ServStockService, public treasServ:TreasuryService, public servSellingRet: SellingRetService,public BranchServ:BranchService
  ...
  ngOnInit() {
    ...
    // this.treasServ.getTreasurys().subscribe( res => this.treasurylist);
  ...
  //     this.dialog.open(DebitNoteComponent, dialogConfig).afterClosed().subscribe(res => { this.calcGrandTotal(); this.calcItemsQty(); });
  //   }
  // }
