...
@Component({
  selector: 'app-rejected-inv',
  templateUrl: './rejected-inv.component.html',
  styleUrls: ['./rejected-inv.component.css']
})
export class RejectedInvComponent implements OnInit {
