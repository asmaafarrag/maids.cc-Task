...
@Component({
  selector: 'app-document-by-type',
  templateUrl: './document-by-type.component.html',
  styleUrls: ['./document-by-type.component.css']
})
export class DocumentByTypeComponent implements OnInit {
