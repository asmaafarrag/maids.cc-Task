...
@Component({
  selector: 'app-purchasings-items',
  templateUrl: './purchasings-items.component.html',
  styleUrls: ['./purchasings-items.component.css']
})
export class PurchasingsItemsComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<PurchasingsItemsComponent>, private servStockService: ServStockService
  ...
  UpdateTotal() {    
    ...
    console.log( this.formData.DollarPriceTot , ' this.formData.DollarPriceTot')
